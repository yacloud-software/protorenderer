module golang.conradwood.net/apis/protorenderer

go 1.18

require (
	github.com/golang/protobuf v1.5.3
	golang.conradwood.net/apis/common v1.1.2690
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2690 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2690 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2690 // indirect
