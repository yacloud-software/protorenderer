...
func (*ZipFile) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }

func (m *ZipFile) GetPayload() []byte {
	if m != nil {
		return m.Payload
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ZipFile)(nil), "protorenderer.ZipFile")
}
...
type ProtoRendererServiceClient interface {
	...
	// get .pb.go files for a given package, stream as zip file
...
func (x *protoRendererServiceGetFilesGoByPackageNameClient) Recv() (*ZipFile, error) {
	m := new(ZipFile)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *protoRendererServiceGetFilesGoByPackageNameServer) Send(m *ZipFile) error {
	return x.ServerStream.SendMsg(m)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
